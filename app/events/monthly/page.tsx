    ...
    return (
        <div className="container mx-auto p-8">
            ...
            <p className="text-lg mb-6">
                We host a mix of events including monthly co-working meetups, casual cafe sessions, hands-on workshops, and networking drinks—all designed to build generative AI learning and founder culture in the GenAI community. Whether you're looking to learn, collaborate, or connect with fellow builders, there's something for everyone. Check out our upcoming events and RSVP below!
            </p>
